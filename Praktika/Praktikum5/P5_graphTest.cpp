 ...
 * Testroutine des Graphen:
	- Tiefensuche mit zusammenhaengenden Graphen
	- Tiefensuche mit nicht zusammenhaengenden Graphen
	- Breitensuche mit zusammenhaengenden Graphen
	- Breitensuche mit nicht zusammenhaengenden Graphen
...
TEST_CASE("Graph Testing", "[Graph]" ) {
	...
	test1->init("/home/mauske/Studium/ADS/ADS/Praktika/Praktikum5/graph1.txt");
	test2->init("/home/mauske/Studium/ADS/ADS/Praktika/Praktikum5/graph2.txt");
	test3->init("/home/mauske/Studium/ADS/ADS/Praktika/Praktikum5/graph3.txt");
